-- ════════════════════════════════════════════════════════════════════════
-- 0094 · PARTE 1 — Los pasajeros de una salida se cuentan en la base
--
-- Pega este bloque entero en el editor SQL de Supabase y ejecútalo.
-- Después ejecuta 0094_parte_2_verificacion.sql: cinco filas, todas OK.
--
-- HASTA QUE ESTO ESTÉ, LA APLICACIÓN NO PUEDE VENDER: `assertCapacity` llama
-- a esta función en cada venta, y si no existe la venta falla con un error de
-- «no se pudieron contar los pasajeros». Es deliberado — la alternativa era
-- seguir vendiendo con un recuento corto, que es lo que causaba la sobreventa.
-- ════════════════════════════════════════════════════════════════════════
