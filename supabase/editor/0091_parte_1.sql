-- 0091 parte 1 de 2 — el monedero se gasta con el cerrojo puesto.
-- Pegar ENTERO en el editor SQL de Supabase y ejecutar. Luego la parte 2.
--
-- Qué arregla: con dos ventas a la vez del mismo socio prepago, las dos leían
-- el MISMO saldo —ninguna veía el consumo de la otra— y las dos pasaban. Con
-- 100 de saldo y dos ventas de 80, el socio acababa en −60. Aquí la suma se
-- hace dentro de la misma transacción que la escritura y detrás de un cerrojo
-- sobre el socio, así que el segundo consumo ve el primero ya escrito.
--
-- Y el descubierto deja de ser invisible: la función devuelve el saldo antes,
-- el de después y si quedó en negativo.
