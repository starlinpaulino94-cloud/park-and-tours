    ...
    groups: [
      {
        ...
        items: [
          ...
          { id: "mi-turno", href: "/dashboard/mi-espacio/turno", label: "Mi turno", icon: "Wallet",
            description: "Lo que llevas cobrado, lo que te quedas y lo que entregas.",
            keywords: ["caja", "turno", "arqueo", "entregar", "comision retenida"] },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "partner-catalogo", href: "/dashboard/partners/catalogo", label: "Catálogo autorizado", icon: "ListChecks", minRole: "manager",
            description: "Qué puede vender cada tour center. Todo nace autorizado: aquí se quita.",
            keywords: ["autorizado", "productos", "contrato", "socio"] },
          { id: "partner-saldo", href: "/dashboard/partners/saldo", label: "Saldo de partners", icon: "Wallet", minRole: "manager",
            description: "Recargas y consumo del saldo prepago de cada tour center." },
...
export const PORTAL_NAV: NavItem[] = [
  ...
  { id: "p-monedero", href: "/portal/monedero", label: "Mi saldo", icon: "Wallet", description: "Lo que ingresaste, lo que gastaste y lo que te queda." },
  ...
  { id: "p-avisos", href: "/portal/avisos", label: "Avisos", icon: "Bell", description: "Confirmaciones, cambios y liquidaciones.", badgeKey: "notifications" },
