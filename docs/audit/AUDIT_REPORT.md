...
| Finanzas | 20 → **50** (tras Fase 4) | Original: ledger decorativo, receivables corruptas, sin idempotencia. **Corregido:** ledger conectado en base efectivo (cobros/reembolsos/liquidaciones asientan y cuadran por construcción), receivables con signo y prorrateo, settlements atómicos y con pago que salda la payable, idempotencia de pagos, topes. **Pendiente:** devengo/CxC en el mayor, comisión condicionada a cobro (F08), multimoneda operativa (F30), saga de orden (F34). |
